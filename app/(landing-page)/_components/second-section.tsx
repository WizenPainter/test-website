                ...
                <div className="md:py-40">
                    <div className="md:flex md:px-20 md:space-x-20 md:space-y-0">
                        <div className="md:w-1/2">
                            <Image src="/images/programming-2.svg" alt="image" width={1920} height={1000} className="object-cover rounded-md w-full p-10"/>
                        </div>
                        <div className="text-white flex space-y-10 md:w-1/2">
                            <div className="md:space-y-10 flex flex-col px-4 py-10 ">
                                ...
                                <div className="text-5xl md:text-7xl pb-4 md:pb-0">
                                    VECA-AI
                                </div>
                                ...
                                <Button className="text-md font-light 2-40 rounded-[40px] border-4 border-indigo-400/90 py-6 
                                bg-[#565add] hover:scale-110 hover:shadow-indigo-300 transition-all duration-300 shadow-md">
                                    Get Veca Glass
                                </Button>
                            </div>
                        </div>
